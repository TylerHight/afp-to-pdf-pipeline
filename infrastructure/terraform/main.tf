...
module "bigquery" {
  ...
  create_lock_table              = var.bigquery_create_lock_table
  lock_table_id                  = var.bigquery_lock_table_id
  lock_table_deletion_protection = var.bigquery_lock_table_deletion_protection
